...
https://github.com/MTayyebKhan/RailsappV2

### Instructions on how to setup, configure and use the App. (Windows)

1. Clone the git repository

        git clone https://github.com/MTayyebKhan/RailsappV2
...
For the two way marketplace each manga has it's own user to be able to edit and delete their own products.
